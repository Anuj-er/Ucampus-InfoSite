...
const styleImages = (Sone, happiness, circle, stwo, chitkara) => {
  return css`
    width: ${Sone
      ? "640px"
      : happiness
...
export const ImageWrapper = styled.div`
  overflow: hidden;
  position: relative;
  ${({ Sone, happiness, stwo, circle , chitkara }) =>
    styleImages(Sone, happiness, stwo, circle, chitkara)};
  margin: ${({ margin }) => (margin ? margin : "")};
  &:before {
    content: "";
    width: 100%;
